...
object TagsUtil {
  ...
  //获取用户ID
  def getOneUserId(line:Row):String={
    line match {
      ...
      case t if StringUtils.isNoneBlank(t.getAs[String]("androidid"))=> "AN"+t.getAs[String]("androidid")
      ...
      case t if StringUtils.isNoneBlank(t.getAs[String]("androididmd5"))=> "AN"+t.getAs[String]("androididmd5")
      ...
      case t if StringUtils.isNoneBlank(t.getAs[String]("androididsha1"))=> "AN"+t.getAs[String]("androididsha1")
      case _ => "其他"
    }
  }
  ...
  def getallUserId(v:Row):List[String]={
    ...
    if(StringUtils.isNotBlank(v.getAs[String]("androidid"))) list:+="AN"+v.getAs[String]("androidid")
    ...
    if(StringUtils.isNotBlank(v.getAs[String]("androididmd5"))) list:+="AN"+v.getAs[String]("androididmd5")
    ...
    if(StringUtils.isNotBlank(v.getAs[String]("androididsha1"))) list:+="AN"+v.getAs[String]("androididsha1")
    list
  }
